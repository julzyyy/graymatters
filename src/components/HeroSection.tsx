      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-center items-center z-10 relative md:mt-20 px-4">
        <div className="flex-[1.3] flex flex-col md:justify-center items-center mt-10 md:mt-0">
          ...
          <div className="px-12 text-zinc-50">
            <p style={{color: "white"}} className="mb-5 text-center font-bold text-lg">
            A simple CCO nft project | 3333 at 0.03e
            </p>
            <img src="/images/coming-soon.png" alt="coming soon" className="mt-0 md:-mt-8" />
            <div style={{display:"flex", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
            
            <button
              style = {{fontSize:"50px", marginBottom: "0px", marginTop: "25px", backgroundColor: "black"}}
              className="hidden text-2xl border-0 w-[33%] py-3 font-bold bg-zinc-900/60 backdrop-blur-sm disabled:opacity-100"
              onClick={(e) => {
                e.preventDefault();
                decrementMintAmount();
              }}
            ...
            className="hidden text-2xl border-0 w-[34%] py-3 font-bold  disabled:opacity-"
            >
             {mintAmount}
            </text>
            ...
            <button
              style = {{fontSize:"50px", marginBottom: "0px", marginTop: "25px", backgroundColor: "black"}}
              className=" hidden text-2xl border-0 w-[33%] py-3 font-bold bg-zinc-900/60 backdrop-blur-sm disabled:opacity-75"
              onClick={(e) => {
                e.preventDefault();
                incrementMintAmount();
              }}
            ...
            <button
              ...
              className=" hidden text-2xl border-0 w-full py-3 font-bold bg-zinc-900/60 backdrop-blur-sm disabled:opacity-75"
